        ...
        <div class="flex-1 space-y-6">
          ...
          <div class="flex flex-wrap items-center gap-3 text-sm">
            {#if media.certification}
              <span
                class="px-3 py-1 rounded-full border font-bold {getColorForCertification(media.certification)}"
              >
                {media.certification}
              </span>
            {/if}
        ...
        {#if seasons.length > 0}
          <div class="flex gap-2 mb-6 overflow-x-auto pb-2 no-scrollbar">
            {#each seasons as season}
              <Button
                variant={selectedSeason === season.seasonNumber ? 'default' : 'ghost'}
                ...
                >
                  ...
                  <div class="flex-1 min-w-0 flex flex-col justify-between py-1">
                    <div>
                      <div class="flex items-start justify-between gap-4">
                        <h3 class="font-semibold text-base md:text-lg line-clamp-1">
                          <span class="text-muted-foreground mr-1">{episode.episodeNumber}.</span>
                    ...
                    <div class="flex items-center justify-between mt-2 md:mt-0">
                      {#if episode.overview}
                        <p class="text-xs text-muted-foreground line-clamp-2 pr-4 hidden md:block">
                          {episode.overview}
                        </p>
                      {/if}
                      ...
                      <Button
                        ...
                        onclick={() => handlePlayEpisode(episode.id, episode)}
        ...
        <div class="space-y-3 text-sm">
          ...
          <div class="flex justify-between">
            ...
            <span class="font-medium"
              >{media.lastPlayedAt ? formatDate(media.lastPlayedAt) : 'Never'}</span
            >
          </div>
        </div>
      </div>
