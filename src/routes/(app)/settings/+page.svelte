...
<Tooltip.Provider delayDuration={300}>
    <div class="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
        <div class="mb-8">
            <h1 class="mt-1 text-3xl font-semibold tracking-tight text-balance">Settings</h1>
        </div>
        ...
        <div class="mb-6 overflow-x-auto lg:hidden">
            <nav class="flex gap-2 pb-1">
                {#each sectionLinks as section}
                    <a
                        href={`#${section.id}`}
                        class="whitespace-nowrap rounded-full border border-white/10 bg-card/60 px-3 py-2 text-sm font-medium text-foreground transition-colors hover:bg-white/8"
                    >
                        {section.label}
                    </a>
                {/each}
        ...
        >
            <aside class="hidden lg:block">
                <div class="sticky top-8 space-y-4">
                    <nav class="rounded-2xl border border-white/10 bg-card/60 p-2">
                        {#each sectionLinks as section}
                            <a
                                href={`#${section.id}`}
            ...
            <div class="space-y-6">
                ...
                <section id="tmdb" class="scroll-mt-8 rounded-2xl border border-white/10 bg-card/60">
                    <div class="flex items-start justify-between gap-4 border-b border-border px-6 py-4">
                        ...
                        <Tooltip.Root>
                            <Tooltip.Trigger
                                ...
                                class="inline-flex h-8 w-8 items-center justify-center rounded-md text-muted-foreground transition-colors hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
                            ...
                            <Tooltip.Portal>
                                <Tooltip.Content
                                    side="top"
                                    sideOffset={8}
                                    class="z-60 rounded-lg border border-border bg-popover px-2.5 py-1.5 text-xs text-popover-foreground shadow-xl"
                                >
                                    Test connection
                                </Tooltip.Content>
                            </Tooltip.Portal>
                ...
                <section id="opensubtitles" class="scroll-mt-8 rounded-2xl border border-white/10 bg-card/60">
                    <div class="flex items-start justify-between gap-4 border-b border-border px-6 py-4">
                        <div class="flex items-start gap-3">
                ...
                <section id="prowlarr" class="scroll-mt-8 rounded-2xl border border-white/10 bg-card/60">
                    <div class="flex items-start justify-between gap-4 border-b border-border px-6 py-4">
                        <div class="flex items-start gap-3">
                    ...
                    <div class="space-y-5 px-6 py-5">
                        <div class="grid gap-5 md:grid-cols-2">
                            <div>
                                <label for="prowlarrUrl" class="mb-2 block text-sm font-medium text-foreground">
                                    URL
                                </label>
                                <Input
                                    id="prowlarrUrl"
                        ...
                        <Collapsible.Root
                            bind:open={indexerManagementOpen}
                            class="rounded-xl border border-white/10 bg-background/60"
                        >
                            <Collapsible.Trigger
                                class="group flex w-full items-center justify-between px-4 py-3 text-sm font-medium text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                            >
