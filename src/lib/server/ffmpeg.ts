...
// Save for when we extract subtitles from movie files directly.
// async function extractSubtitleAsVtt(inputPath: string, streamIndex: number, outputPath: string): Promise<void> {
// 	return new Promise((resolve, reject) => {
// 		ffmpeg(inputPath)
